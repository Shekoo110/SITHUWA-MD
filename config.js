...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'sherlock bot',
  packname:  process.env.PACK_NAME || 'MADE BY kaiser',
  
  botname:   process.env.BOT_NAME === undefined ? "Kaiser_MD" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'sherlocok' : process.env.OWNER_NAME,  
